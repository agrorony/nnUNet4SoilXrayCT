"""
Standalone inference for iter03 model on nlm_volume (Beni Ram).

Uses pre-split chunks in bnei_reem_iter03/inference_input/.
Produces predictions in bnei_reem_iter03/inference_output/.
Concatenates to bnei_reem_iter03/inference_concatenated/nlm_volume.nii.gz.
...
if __name__ == '__main__':
    ...
    MODEL_DIR  = os.path.join(
        HIVE_BASE, 'multi_sample_iter03', 'nnUNet_results', 'Dataset777_GCEF',
    ...
    print(f'\n{"="*70}')
    print(f'DONE — iter03 final prediction:')
