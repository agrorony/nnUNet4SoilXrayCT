"""Inference for fresh_bnei_reem_i3_scratch on nlm_volume."""
...
if __name__ == '__main__':
    ...
    MODEL_DIR  = os.path.join(HIVE_BASE, 'multi_sample_fresh_bnei_reem_i3_scratch',
    ...
    PRED_DIR   = os.path.join(HIVE_BASE, 'bnei_reem_fresh_bnei_reem_i3_scratch', 'inference_output')
    CONCAT_DIR = os.path.join(HIVE_BASE, 'bnei_reem_fresh_bnei_reem_i3_scratch', 'inference_concatenated')
