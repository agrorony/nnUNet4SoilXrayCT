...
pred = os.path.join(HIVE_BASE, 'bnei_reem_fresh_bnei_reem_i2', 'inference_concatenated', 'nlm_volume.nii.gz')
gt   = os.path.join(HIVE_BASE, 'fresh_train_annotations_bnei_reem', 'annotations_i2.nii.gz')
