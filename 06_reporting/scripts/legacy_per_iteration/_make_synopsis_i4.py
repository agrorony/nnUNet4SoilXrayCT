...
Synopsis export: one PNG per annotated z-slice showing
  [Raw CT]  |  [GT Annotations i3]  |  [Prediction fresh_bnei_reem_i3_scratch]
...
pred_path = os.path.join(HIVE_BASE, 'bnei_reem_fresh_bnei_reem_i3_scratch',
...
out_dir   = os.path.join(REPO_DIR, 'analysis', 'synopsis_i4')
...
for idx, z in enumerate(ann_slices):
    ...
    render_overlay(axes[2], ct, p, 'Prediction  (fresh_bnei_reem_i3_scratch)')
