...
LOCAL_BASE          = os.path.join(HIVE_BASE, 'multi_sample_fresh_bnei_reem_i3')
...
# Pretrained weights: fresh_bnei_reem_i2 checkpoint (fine-tuning from it)
...
plt.title('Training Metrics — fresh_bnei_reem_i3 (fine-tune from i2)', fontsize=14, fontweight='bold')
plt.tight_layout()
...
# ── Inference ─────────────────────────────────────────────────────────────────
print('\n' + '=' * 70)
print('Running inference with fresh_bnei_reem_i3 model ...')
print('=' * 70)

inf_script = os.path.join(REPO_DIR, '_run_inference_fresh_bnei_reem_i3.py')
...
print('\n[OK] fresh_bnei_reem_i3 pipeline complete.')
